...
for payload in range_payloads:
    ...
    w=1
    ax.bar(msg_rates_temp, delays, yerr=error, align='center', alpha=0.5, ecolor='black', capsize=6, width=w, label='payload: '+str(payload)+' bytes')
    j += 1
    ...
    ax.set_title('Average of end to end delays\n with standard deviation')
    ax.yaxis.grid(True)
